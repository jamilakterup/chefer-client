    ...
    return (
        <footer className="footer p-10 bg-base-200 text-base-content mt-36">
            <div>
                ...
                <p>Chefer Restaurant Ltd.<br />Providing fresh food since 2020</p>
            </div>
            <div>
                <span className="footer-title">Services</span>
                <Link className="link link-hover">Home delivery</Link>
                <Link className="link link-hover">Cooking</Link>
                <Link className="link link-hover">Food service</Link>
